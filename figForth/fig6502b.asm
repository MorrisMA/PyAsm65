...
;
SPTOS       .equ    0xFF            ;top of data stack, in page 1.
RPTOS       .equ    0xA0            ;top of return stack, in page 0
RPBOS       .equ    0x20            ;bottom of return stack, in page 0
N           .equ    RPTOS+8         ;RPTOS+8         ;scratch workspace.
...
;
NAME_LENGTH .equ    31
PFA_OFFSET  .equ    5               ; offset from last char of name to PFA
;
SGN_BIT     .equ    128
MSB_MSK     .equ    127
IMM_BIT     .equ    64
...
;
COLD_LEN    .equ    $-INIT_NTOP-1
WARM_LEN    .equ    INIT_FENCE-INIT_NTOP-1
;
;   Forth Break Point Table
;
FORTH_BKPT0 .wrd    0
FORTH_BKPT1 .wrd    0
FORTH_BKPT2 .wrd    0
...
L249        ldy     #0          ; reset y register
            ...
            and     #LEN_MSK    ; mask off msb and nsb (smudge bit)
...
WARM        ldy     #WARM_LEN
;
L2433       lda.w   INIT_UAREA
            sta.w   UP
;
L2437       lda     INIT_NTOP,Y
            sta     (UP),Y
            dey 
            bpl     L2437
;
...
L3660       .wrd    L3647-L3660 ;0xFFE6
            .wrd    CLIT
            .byt    FORM_FEED   ;form feed for printer
            .wrd    EMIT
            .wrd    SEMIS
;       
;           TRIAD
